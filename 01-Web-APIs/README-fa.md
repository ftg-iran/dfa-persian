...
خط بالایی خط پاسخ است و مشخص می کند که ما از HTTP/1.1 استفاده می کنیم. کد وضعیت 200 OK نشان‌دهنده موفقیت‌آمیز بودن درخواست مشتری است (به زودی در مورد کدهای وضعیت بیشتر توضیح خواهیم داد).
